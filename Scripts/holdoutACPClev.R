...
newdata = data.frame(cbind(Y,age,trestbps,chol,cigs,years,ekgmo,ekgday,ekgyr,thaldur,thaltime,met,thalach,thalrest,tpeakbps,tpeakbpd,dummy,trestbpd,oldpeak,rldv5e,ca,cmo,cday,cyr,lmt,ladprox,laddist,cxmain,om1,rcaprox,rcadist,lvx3,lvx4,lvf,X)) #### ACP
