...
# 1 - Y~sex+htn
# 2 - Y~sex+age+htn+PAM+RC
# 3 - Y~htn+RC+IPPARC
# 4 - Y~htn+PAM+ALPHA+ALPHA2
# 5 - Y~htn+PAM+ALPHA2
...
DadostestRF2=na.omit(data.frame(dadostest$Y,dadostest$sex,dadostest$age,dadostest$htn,dadostest$PAM,dadostest$RC))
RF2=randomForest(Y~sex+age+htn+PAM+RC,data = dadostrei,xtest=DadostestRF2[,-1],ytest=DadostestRF2$dadostest.Y,na.action = na.omit)

DadostestRF3=na.omit(data.frame(dadostest$Y,dadostest$htn,dadostest$RC,dadostest$IPPARC))
RF3=randomForest(Y~htn+RC+IPPARC,data = dadostrei,xtest=DadostestRF3[,-1],ytest=DadostestRF3$dadostest.Y,na.action = na.omit)

DadostestRF4=na.omit(data.frame(dadostest$Y,dadostest$htn,dadostest$PAM,dadostest$ALPHA,dadostest$ALPHA2))
RF4=randomForest(Y~htn+PAM+ALPHA+ALPHA2,data = dadostrei,xtest=DadostestRF4[,-1],ytest=DadostestRF4$dadostest.Y,na.action = na.omit)

DadostestRF5=na.omit(data.frame(dadostest$Y,dadostest$htn,dadostest$PAM,dadostest$ALPHA2))
RF5=randomForest(Y~htn+PAM+ALPHA2,data = dadostrei,xtest=DadostestRF5[,-1],ytest=DadostestRF5$dadostest.Y,na.action = na.omit)
...
modSVM2=svm(Y~sex+age+htn+PAM+RC,data=dadostrei,scale=F,kernel="poly",cost=100,epsilon=1.0e-12)
YestSVM2test=predict(modSVM2,dadostest);YestSVM2trei=modSVM2$fitted

modSVM3=svm(Y~htn+RC+IPPARC,scale=F,data=dadostrei,kernel="poly",cost=100,epsilon=1.0e-12)
YestSVM3test=predict(modSVM3,dadostest);YestSVM3trei=modSVM3$fitted

modSVM4=svm(Y~htn+PAM+ALPHA+ALPHA2,data=dadostrei,scale=F,kernel="poly",cost=100,epsilon=1.0e-12)
YestSVM4test=predict(modSVM4,dadostest);YestSVM4trei=modSVM4$fitted

modSVM5=svm(Y~htn+PAM+ALPHA2,data=dadostrei,scale=F,kernel="poly",cost=100,epsilon=1.0e-12)
...
modLR2=glm(Y~sex+age+htn+PAM+RC,data=dadostrei,family = binomial(link = "logit"))
...
modLR3=glm(Y~htn+RC+IPPARC,data=dadostrei,family = binomial(link = "logit"))
...
modLR4=glm(Y~htn+PAM+ALPHA+ALPHA2,data=dadostrei,family = binomial(link = "logit"))
...
modLR5=glm(Y~htn+PAM+ALPHA2,data=dadostrei,family = binomial(link = "logit"))
