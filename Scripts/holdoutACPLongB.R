...
newdata = data.frame(cbind(Y,age,trestbps,chol,cigs,years,restecg,proto,thaldur,met,thalach,thalrest,tpeakbps,tpeakbpd,dummy,trestbpd,oldpeak,rldv5,rldv5e,lvx2,lvx3,lvx4,lvf,X))
