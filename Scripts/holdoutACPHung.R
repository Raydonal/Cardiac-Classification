...
newdata = data.frame(cbind(Y,age,trestbps,chol,restecg,proto,thaldur,met,thalach,thalrest,tpeakbps,tpeakbpd,dummy,trestbpd,oldpeak,rldv5,rldv5e,lvx2,lvx3,lvx4,lvf,X))
